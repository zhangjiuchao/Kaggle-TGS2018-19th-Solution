...
class SEBottleneck(Bottleneck):
    ...
    def __init__(self, in_planes, planes, groups, reduction, stride=1, downsample=None):
...
class SENet(nn.Module):
    ...
    def __init__(self, block, layers, groups, reduction, dropout_p=0.2, inplanes=128,
...
def senet154(num_classes=1000, pretrained='imagenet'):
    ...
    if pretrained is not None:
        model.load_state_dict(model_zoo.load_url('http://data.lip6.fr/cadene/pretrainedmodels/senet154-c7b49a05.pth'))
    return model
